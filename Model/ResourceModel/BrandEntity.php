 ...
 */
namespace Magerubik\Shopbybrand\Model\ResourceModel;
class BrandEntity extends AbstractResource
{
	...
	public function __construct(
		...
		\Magerubik\Shopbybrand\Model\Factory $modelFactory,
		$data = []
	) {
		parent::__construct(
            $context,
    ...
    {
        if (empty($this->_type)) {
            $this->setType('magerubik_product_brand_entity');
        }
	...
	public function load($object, $entityId, $attributes = [])
	{
		...
		$mainTable = $this->getTable('magerubik_product_brand_entity');
