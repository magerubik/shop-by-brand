...
class BrandSlider extends \Magerubik\Shopbybrand\Block\Widget\BrandAbstract
{
    ...
    public function getAlphabetTable() {
        ...
        if (!$alphabetString) {
            $alphabetString = $this->_copeConfig->getValue('magerubik_shopbybrand/all_brand_page/alphabet_table')?:'a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z';
        }
