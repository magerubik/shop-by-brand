...
namespace Magerubik\Shopbybrand\Model\ResourceModel\AttributesList;
...
class Collection extends \Magento\Eav\Model\ResourceModel\Entity\Attribute\Collection
{
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(
            ...
            $this->_eavEntityFactory->create()->setType(\Magerubik\Shopbybrand\Model\AttributesList::ENTITY)->getTypeId()
        );
        return $this;
    }
